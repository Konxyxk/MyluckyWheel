	...
	var tips=[];
	 var record = $(".tips");
	  for (var i=0;i<record.length;i++){
          tips.push(record.eq(i).html());
	  }
	
//	var tips = ["100代金券", "50元话费", "20元话费","谢谢参与~", "谢谢参与~","谢谢参与~"],//中奖提示
//	var tips = new Array();
//	<c:forEach items="${table}" var="t">
//		tips.push('${t.prize}');
//	</c:forEach> 
//    var tips="${table.prize}",
        $ring = $(".ring"),
        $prize = $(".prize"),//转盘
        $btn = $("#btn"),//按钮
...
//        timer;//定时器
    ...
    $btn.click(function () {
    	...
    	$.get('http://localhost:8080/runtable9.0/play',{},function(ret){
	        ...
	        if (data.count<=0) { //当抽奖次数为0时
	            ...
	            alert("中奖编号为"+ret.id);
	            alert("中奖概率为"+ret.v);
	          switch (id) {//中奖概率，可控。根据得到的随机数控制奖品
	              case 1:
...
//            case 2:
//			
//                rotateFn(2, 60, tips[2]);
//                break;
//            case 3:
//			 
//                rotateFn(3, 180, tips[3]);
//                break;
//            case 4:
//			
//                rotateFn(4, 120, tips[4]);
//                break;
//            case 5:
//			
//                rotateFn(5, -60, tips[5]);
//                break;
//            case 6:
//			
//                rotateFn(6, -120, tips[6]);
//                break;
//        }
//    }
